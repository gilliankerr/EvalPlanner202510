    ...
    <div className="p-8">
      ...
      <div className="space-y-6">
        ...
        <div className={`p-6 rounded-lg border ${
          analysisStatus === 'analyzing' ? 'bg-lo-blue/5 border-lo-blue/20' :
        ...
        {analysisStatus === 'analyzing' && (
          <div className="space-y-4">
            <div className="flex items-center space-x-3">
              <div className="w-2 h-2 bg-lo-blue rounded-full animate-pulse"></div>
              <span className="text-sm text-lo-charcoal/70">Identifying target population and presenting issues</span>
            </div>
            <div className="flex items-center space-x-3">
              <div className="w-2 h-2 bg-lo-blue rounded-full animate-pulse" style={{ animationDelay: '0.5s' }}></div>
              <span className="text-sm text-lo-charcoal/70">Analyzing core intervention strategies</span>
            </div>
            <div className="flex items-center space-x-3">
              <div className="w-2 h-2 bg-lo-blue rounded-full animate-pulse" style={{ animationDelay: '1s' }}></div>
              <span className="text-sm text-lo-charcoal/70">Determining theoretical foundations</span>
            </div>
            <div className="flex items-center space-x-3">
              <div className="w-2 h-2 bg-lo-blue rounded-full animate-pulse" style={{ animationDelay: '1.5s' }}></div>
        ...
        {analysisResult && (
          <div className="mt-8">
            ...
            <div className="bg-lo-gray/30 rounded-lg p-6 max-h-96 overflow-y-auto border border-lo-gray">
              <div className="prose prose-sm max-w-none">
                <pre className="whitespace-pre-wrap text-sm text-lo-charcoal/80 font-sans">
                  {analysisResult}
                </pre>
              </div>
            </div>
        ...
        {/* Technical Details */}
        <div className="bg-lo-gray/30 rounded-lg p-4 border border-lo-gray">
          <h4 className="text-sm font-medium text-lo-charcoal mb-2">Analysis Parameters</h4>
